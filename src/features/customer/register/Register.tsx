              ...
              <div className='hidden md:block md:w-1/2 bg-white relative'>
                <div className='absolute inset-0 flex items-center justify-center p-8'>
                  <div className='text-center'>
                    ...
                    <Text className='text-gray-600'>Tham gia cùng chúng tôi để trải nghiệm mua sắm tốt nhất</Text>
                  </div>
                </div>
              </div>
              ...
              <div className='w-full md:w-1/2 p-8 md:p-12'>
                <div className='max-w-md mx-auto'>
                  <div className='text-center mb-8'>
                    ...
                    <Text className='text-gray-500'>Vui lòng điền đầy đủ thông tin để đăng ký</Text>
                  </div>

                  <Form form={form} layout='vertical' size='large' className='space-y-4'>
                    <Form.Item
                      name='name'
                      rules={[
